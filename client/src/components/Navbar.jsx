                    ...
                    <div className="px-2 mx-auto sm:px-6 lg:px-8">
                        <div className="relative flex items-center justify-between h-16">
                            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                                {/* Mobile menu button*/}
                                <Disclosure.Button
                                    className="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:bg-zinc-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                            ...
                            <div
                                className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-0 sm:pr-0">
                                {itsMe.username || itsMe.login ? (
                                    <>
                                        ...
                                        >
                                            <div>
                                                <Menu.Button
                                                    className="flex text-sm text-gray-400 bg-gray-800 rounded-full hover:text-lime-500 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
													<span className="sr-only">
														Open language menu
													</span>
                                                    <svg
                                        ...
                                        >
                                            <div>
                                                <Menu.Button
                                                    className="flex text-sm bg-gray-800 rounded-full focus:outline-none focus:ring-2 focus:ring-lime focus:ring-offset-2 focus:ring-offset-lime-500">
													<span className="sr-only">
														Open user menu
													</span>
                                                    <img
                                    ...
                                    <>
                                        ...
                                        <a
                                            href="/login"
                                            className="inline-flex items-center justify-center px-2 py-1 ml-2 text-base text-gray-200 border border-transparent rounded-xl font-sm bg-lime-600 hover:bg-lime-700"
                                        >
                                            {t('Navbar.SignIn')}
                                        </a>
                                    </>
