			...
			{itsMe.username ? (
				<>
					...
					<div className="flex-1">
						{isFormVisible && (
							<form className="text-gray-600 search-form">
								<label
					...
					<div onClick={() => setFormVisible(!isFormVisible)}>
						<svg
							aria-hidden="true"
							className="text-red-500 w-7 h-7 justify-self-end"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
							xmlns="http://www.w3.org/2000/svg"
					...
					<Navbar.Toggle className="mb-1 ml-6 text-red-500 border border-red-500 hover:bg-transparent hover:text-red-500 focus:text-red-500 focus:bg-transparent focus:border-red-500" />

					<Navbar.Collapse className="bg-zinc-900">
						<Navbar.Link
							className="font-medium text-red-600 bg-zinc-900 hover:bg-zinc-800 hover:text-red-600"
							href="/list"
							// active={true}
						>
							List
