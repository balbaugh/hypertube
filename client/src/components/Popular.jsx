...
const Popular = () => {
    ...
    const loadMoreMovies = async () => {
        setIsLoading(true);
        const response = await axios.get(`https://yts.mx/api/v2/list_movies.json?sort_by=download_count&order_by=desc&limit=50&page=${currentPage}`, { withCredentials: false });
