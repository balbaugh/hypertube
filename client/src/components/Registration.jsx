					...
					<div className="max-w-lg mx-auto">
						...
						<form onSubmit={register}>
							...
							<div className="mb-6">
								...
								<input
									className="inline-block w-full p-4 font-semibold leading-6 rounded-lg text-md placeholder-slate-500 bg-slate-200 focus:border-red-500 focus:ring-1 focus:ring-red-500 focus:outline-none"
									type="text"
